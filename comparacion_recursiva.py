...
if __name__ == "__main__":
    ...
    # --- CONCLUSIÓN GENERAL ---
    print(f"\n\n{'='*70}")
    print("### CONCLUSIÓN GENERAL DE LA COMPARATIVA ###")
    print(f"{'='*70}")
    print("En Python, por lo general, las versiones ITERATIVAS suelen ser más rápidas que sus equivalentes recursivas.")
    print("Esto se debe al 'overhead' o costo adicional que genera cada llamada a una función en la recursividad.")
    print("Aunque la recursividad puede ser más elegante y clara para ciertos problemas (como la búsqueda binaria),")
    print("la iteración es a menudo más eficiente en términos de rendimiento puro.")